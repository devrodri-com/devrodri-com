<p align="center">
  <img src="./assets/devrodri-services-banner.png" alt="DevRodri — Websites, Custom Software, Integrations, and Automation" width="100%" />
</p>
...
| **Jacquie Zárate Real Estate** | Trilingual Next.js real-estate site for Miami buyers and investors, with localized ES/EN/FR-CA content, a searchable and filterable pre-construction catalog, reusable project and property pages, per-language SEO, optimized media, direct WhatsApp paths, and a hardened contact endpoint. | [Live](https://jacquiezarate.com) · [Code](https://github.com/devrodri-com/jacquie-real-estate) |
